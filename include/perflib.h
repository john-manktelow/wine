...
ULONG WINAPI PerfIncrementULongLongCounterValue(HANDLE, PERF_COUNTERSET_INSTANCE *, ULONG, ULONGLONG);
ULONG WINAPI PerfIncrementULongCounterValue(HANDLE, PERF_COUNTERSET_INSTANCE *, ULONG, ULONG);
